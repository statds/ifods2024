...
.PHONY: push
push:
	aws s3 sync --profile statds photos/ s3://$(bucketName)/events/ifods2024/photos --delete \
	--exclude ".DS_Store" \
	--exclude "**/.DS_Store"
...
.PHONY: pull
pull:
	aws s3 sync --profile statds s3://$(bucketName)/events/ifods2024/photos photos/ --delete \
	--exclude ".DS_Store" \
	--exclude "**/.DS_Store"
